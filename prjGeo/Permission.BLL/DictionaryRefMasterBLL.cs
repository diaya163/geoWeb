...
{
	/// <summary>
	/// DictionaryRefMasterBLL
	/// </summary>
	public partial class DictionaryRefMasterBLL
	{
        private static readonly DictionaryRefMasterDAL dal = new DictionaryRefMasterDAL();
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters,string orderBy,int topNo, int pageSize, int pageIndex, ref int rCount, ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters,int pageSize, int pageIndex,ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters,string orderBy,int TopNo, ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters,string orderBy, ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters,int TopNo, ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static IList<DictionaryRefMaster> GetList(string filters, ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static int Add(DictionaryRefMaster model,ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static  bool Update(DictionaryRefMaster model,ref string errMsg){
		...
		/// <param name="errMsg">错误信息</param>
		/// <returns></returns>
		public static bool Delete(DictionaryRefMaster model,ref string errMsg){
        ...
        public static string SelectFiledsByFilters(string fileds, string filters,string appSettings, ref string errMsg) {
            DictionaryRefMasterDAL dal = new DictionaryRefMasterDAL(appSettings);
            return dal.SelectFiledsByFilters(fileds, filters, ref errMsg);
